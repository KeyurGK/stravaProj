...
//       <h1 className="text-2xl font-bold mb-4">Strava OAuth Demo</h1>
//       {!accessToken ? (
//         <button onClick={handleAuth} className="px-4 py-2 bg-blue-500 text-white rounded">
//           Connect with Strava
//         </button>
//       ) : (
//         <div className="flex flex-col gap-4">
//           <button onClick={() => navigate("/runs")} className="px-4 py-2 bg-green-500 text-white rounded">
//             Best Runs
//           </button>
